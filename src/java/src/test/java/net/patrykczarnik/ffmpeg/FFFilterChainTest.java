...
public class FFFilterChainTest {
	...
	public void testEmpty() {
		...
		assertThat(chain.getStartLabel()).isNull();
		assertThat(chain.getEndLabel()).isNull();
	...
	public void testLabels() {
		...
		assertThat(chain.getStartLabel()).isEqualTo("AA");
		assertThat(chain.getEndLabel()).isEqualTo("BB");
		assertThat(chain.getFilters()).isEmpty();
